...
UCLASS()
class GASOLINECIRCLE_API AProjectileDefault : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	virtual void Tick(float DeltaTime) override;
		...
		void BulletCollisionSphereHit(class UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpule, const FHitResult& Hit);
